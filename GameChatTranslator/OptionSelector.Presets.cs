...
namespace GameTranslator
{
    public partial class OptionSelector
    {
        ...
        private void SavePreset(string presetName)
        {
            ...
            _ini.Write("Key_PauseTranslate", TxtKeyPause.Text, section);

            foreach (string key in PresetSettingKeys.Where(key => key.StartsWith("Capture") || key.StartsWith("Window")))
            {
        ...
        private void LoadPreset(string presetName)
        {
            ...
            TxtKeyPause.Text = ReadPresetValue(section, "Key_PauseTranslate", "Ctrl+P");
