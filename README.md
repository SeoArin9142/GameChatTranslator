...
[**👉 GameChatTranslator v1.0.4 다운로드 받기**](https://github.com/SeoArin9142/GameChatTranslator/releases/download/v.1.0.4/GameChatTranslator_v1.0.4.zip)
...
- **업데이트 확인**: GitHub 릴리즈 기준 최신 버전 확인.
- **번역 결과 복사**: 최근 번역 결과를 버튼으로 클립보드에 복사.
