...
[**👉 GameChatTranslator v1.0.5 다운로드 받기**](https://github.com/SeoArin9142/GameChatTranslator/releases/download/v.1.0.5/GameChatTranslator_v1.0.5.zip)
...
- **OCR 전처리 자동 선택**: RGB 필터, 글자 굵기 보정, 적응형 이진화 결과를 비교해 배경 노이즈가 적은 결과를 사용.
